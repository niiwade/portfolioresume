...
export default function NavBar({
  ...
  return (
    <nav aria-label="Main navigation">
      <ul className="flex flex-col justify-between rounded-b-full  px-4 py-10 md:m-4 md:flex-row md:items-center md:rounded-xl">
...
function NameLogo({ name }: { name: KeyTextField }) {
  return (
    <Link
      ...
      className="text-xl font-extrabold tracking-loose text-white"
    >
      {name}
    </Link>
  );
